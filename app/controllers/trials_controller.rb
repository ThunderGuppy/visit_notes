class TrialsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @trial.save
        format.html { redirect_to trial_url(@trial), notice: "Trial was successfully created." }
  ...
  def update
    respond_to do |format|
      if @trial.update(trial_params)
        format.html { redirect_to trial_url(@trial), notice: "Trial was successfully updated." }
